        ...
        try {
            ...
            if (newGroup) {
                ...
                setTimeout(async () => {
                    ...
                    // FIX: Refresh groups data and re-render before switching tabs
                    if (window.advancedGroupsSystem) {
                        // Reload groups from API
                        // await window.advancedGroupsSystem.initializeGroups(); // DISABLED - groups already reload via switchTab
                    }
