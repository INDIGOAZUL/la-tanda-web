...
class EnhancedAPIProxy {
    constructor() {
        ...
        this.API_BASE = null; // Temporarily disabled: isProduction ? 'https://latanda.online' : null;
        ...
        this.useRealAPI = true; // Temporarily disabled: isProduction && !isLocalhost;
    ...
    async handleGroupsCreate(options) {
        ...
        const newGroup = {
            ...
            coordinator_id: body.coordinator_id || (JSON.parse(localStorage.getItem("latanda_user") || "{}").id) || "unknown",
            member_count: 1,
